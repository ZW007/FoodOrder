...
router.get("/register", function (req, res) {
	if (req.query.username && req.xhr) {
		...
		Account.findOne({ username: req.query.username }, function (err, user) {
			...
			var message;
			if (user) {
				message = "The username you entered has already been occupied!";
			} else {
				message = "The username you entered is valid!";
			}
...
router.get("/menus", async (req, res, next) => {
	...
	// req.xhr indicating whether the current request (req) appears to be an AJAX request (i.e. it was issued with its "X-Requested-With" header set to "XMLHttpRequest").
	// return value of req.xhr  is either true or false
